...
urlpatterns = [
    ...
    path('api/furnace-available/', views.check_furnace_availability, name='check_furnace_availability'),
    path(
    ...
    # AJAX helpers
    path('api/equipment-available/', views.check_equipment_availability, name='check_equipment_availability'),
